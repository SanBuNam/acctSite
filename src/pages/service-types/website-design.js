      ...
      <div className={styles.innerContainer}>
        <Fragment>
          ...
          <ul>
            <li>
              ...
              and visually supports your professional reputation. An ugly site
              is never advantageous; if a site is doing well while looking old
              or broken, the owner’s efforts would be better spent on more
              profitable activities rather than overcoming the site’s
        ...
        <Fragment>
          ...
          <p>
            ...
            iterations they are willing to go through, Web Developers Studio
            never yet told a client “Sorry Pal, that’s it. Take it or leave it”.
            We just keep designing, designing, and designing until each client
            is delighted (so far).
          </p>
          <p>
        ...
        <Fragment>
          <h5>Great Content</h5>
          <p>
            You are the repository of a tremendous amount of deep-knowledge
            about your business, organization, or practice. At Web Developers
            Studio, we factor in the time need to help you formulate that into
            the great “content” that will draw the search engines to your site.
            Then they draw the clients you need to attract. Low cost providers
            do not typically calculate that into their estimates, but the
        ...
        <Fragment>
          ...
          <p>
            ...
            Second best is shots you took yourself. We can often photoshop them
            to be more than you think. Finally, if we have nothing else to
            decorate our pages, we recommend stock photos in a pinch.
          </p>
        </Fragment>
      </div>
    </div>
