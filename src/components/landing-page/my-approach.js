  ...
  return (
    <section className={styles.container}>
      ...
      <p className={styles.bottomParagraph}>
        ...
        and that we meet the agreed deadline. With every project, <br />I strive
        to create an engaging, user friendly website, built to convert and
        maximize your ROI. <br />I believe in transparency and honesty. This
        underlines everything I do.
      </p>
    </section>
  )
}
