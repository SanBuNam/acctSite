      ...
      <Fragment>
        <h4>
          <span className={styles.title}>
            Looking to hire a Orange County, CA
          </span>
          <br />
        ...
        <div className={styles.textDiv}>
          <p>
            I create websites and applications, built to convert, improve
            business processes and{" "}
            <span>maximize ROI here in Orange County, CA</span>.
            <br />
          </p>
          <p>
            Over the last 15 years, I’ve worked with Orange County-based
            companies such as{" "}
